...
<section class="checkout-section spad">
    ...
    <form action="{{ route('checkout.delivery.process') }}" method="POST" id="deliveryForm">
        @csrf
                    ...
                    <div class="place-order order-summary">
                        ...
                        <div class="order-total">
                                    ...
                                    <tbody>
                                        @forelse ($cart as $item)
                                                    <tr>
                                                        <td>
                                                            @if (!empty($item['image']))
                                                                <images src="{{ $item['image'] }}" alt="{{ $item['name'] }}" style="max-width: 50px;">
                                                            @else
                                                                <span>No image</span>
                                                            @endif
                                                        </td>
                            ...
                            <ul class="order-table list-unstyled mt-3">
                                ...
                                <li class="total-price fw-bold">Total <span id="order-total">RM{{ number_format($subtotal + $salesTax, 2) }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const salesTax = parseFloat("{{ $salesTax }}");

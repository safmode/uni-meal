...
<section class="mb-10 mt-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 px-4">
        <?php $__currentLoopData = ['Drinks', 'Pizza', 'Mee', 'Nasi', 'Soup']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
